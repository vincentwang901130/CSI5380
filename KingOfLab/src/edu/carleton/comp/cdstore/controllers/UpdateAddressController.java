...
* this class is a servlet which implements the functionality that update order's shipping address info
...
public class UpdateAddressController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    WebTarget target = client.target(GetBaseURL.getOrderBaseURI()+"/rest/updateAddress");
